    ...
    <!-- Header Section -->
        ...
        <section class="header-section">
            <div class="right-section">
                <h2>Buy With Tokens</h2>
                <h3>Sell For Tokens And Buy with Token</h3>
                ...
                <form action="../search/sell.php" method="POST">
        ...
        <section class="books">
            ...
            <div class="all-books">
                <?php
                    ...
                    $start = ($page - 1) * $limit;
                    $sql = "SELECT * FROM book WHERE lendType = 'sell' LIMIT $start, $limit";
                ...
                <div class="single-book">
                    ...
                    <div class="exchange">
                        <a href="./buyForToken.php?id=<?= $row['id'] ?>">
                            <button>Buy With Tokens</button>
                        </a>
                    </div>
                </div>
                <?php
