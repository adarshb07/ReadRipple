...
<head>
    ...
    <link rel="stylesheet" href="../../assets/styles/my-book.css">
        ...
        <div class="main-container">
            <div class="left">
                <div class="menu">
                    <ul>
                        ...
                        <li><a href="../my-books/" class="active"><i class="fa fa-book"></i> My Books</a></li>
            ...
            <div class="right"> 
                ...
                <table>
                    ...
                    <tr>
                        <td><img src="../../assets/images/books/<?= $book['image'] ?>" alt=""></td>
                        <td><?php
                                $limit = 20;
                                $bookTitle = $book['bookTitle'];
                                if(strlen($bookTitle) > $limit){
                                    $bookTitle = substr($bookTitle, 0, $limit) . "...";
                                }
                                echo $bookTitle;
                        ?></td>
                        <td>
                            <?php
                                $csql = "Select * from categories where id = ".$book['category'];"";
                                $cresult = mysqli_query($conn, $csql);
                                $category = mysqli_fetch_assoc($cresult);
                                // Workd limit
                                $limit = 12;
                                $categoryName = $category['name'];
                                if(strlen($categoryName) > $limit){
                                    $categoryName = substr($categoryName, 0, $limit) . "...";
                                }
                                echo $categoryName;
                            ?>
                        </td>
